...
from .mvsplat.mvsplat import MVSPlatConfig, MVSPlat

config_factory = {'ANet': ANetConfig, 'BNet': BNetConfig, 'UniMatch': UniMatchConfig, 'MVSPlat': MVSPlatConfig}
model_factory = {'ANet': ANet, 'BNet': BNet, 'UniMatch': UniMatch, 'MVSPlat': MVSPlat}
